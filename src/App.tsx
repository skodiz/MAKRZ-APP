...
.app {
  ...
  .nav-item { display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 4px; padding-top: 6px; color: #8C857E; font-size: 11px; cursor: pointer; border: none; background: none; font-family: 'DM Sans', sans-serif; }
