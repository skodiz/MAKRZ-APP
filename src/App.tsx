...
.filter-choice.active { background:#6D9577; color:#FFFFFF; font-weight:700; }
  ...
  /* INNER TABS */
  .inner-tabs { display: grid; grid-template-columns: repeat(3, 1fr); height: 46px; background: var(--shell); border-bottom: none; flex-shrink: 0; }
...
.reply-count {
  ...
  .f-input { height: 42px; width: 100%; border: 1px solid #E6DDD2; background: #FDFBF8; border-radius: 12px; padding: 10px 12px; font-size: 16px}
